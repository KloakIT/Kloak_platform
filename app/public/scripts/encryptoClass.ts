...
const showHTMLComplete = ( uuid: string, base64zipStream: string, base64: boolean, CallBack ) => {
...
class encryptoClass {
	...
	public decryptStreamWithoutPublicKey = async ( encryptoText: string, CallBack ) => {
		const _self = this
	...
	public async encryptStream_withMyPublicKey ( message: Buffer, CallBack ) {
	...
	public encryptString_withMyPublicKey ( message: string, CallBack ) {
