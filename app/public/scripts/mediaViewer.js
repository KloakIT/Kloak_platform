class MediaViewer {
    constructor(type, filename, options, _callback, exit) {
        ...
        this.videoInit = null;
        this.audioInit = null;
        this.calledInit = { video: false, audio: false };
        ...
        this.videoArray = [];
        this.audioArray = [];
        this.currentVideoPoint = 1;
        this.currentAudioPoint = 1;
        this.videoDataAppendRunning = false;
        this.audioDataAppendRunning = false;
        ...
        this.streamYoutubeVideo = () => {
            const types = this.options['youtubeStreamingData']['adaptiveFormats'];
