class Assembler {
	...
	constructor ( requestUuid: string, progressIndicator: KnockoutObservable<number> | Function, callback: Function) {
	...
	getFileType = (magicNumber: string) => {
